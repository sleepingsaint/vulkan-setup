...
VkBufferCreateInfo vkInit::createBufferCreateInfo(VkDeviceSize size, VkBufferUsageFlags usageFlags){
...
VkPushConstantRange vkInit::createPushConstantRange(uint32_t size, VkShaderStageFlags stageFlags){
